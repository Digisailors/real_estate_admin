                    ...
                    child: StatefulBuilder(builder: (context, reload) {
                      ...
                      return TileFormField(
                        ...
                        controller: TextEditingController(
                            text: property?.propertyAmount.toString()),
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          if (_formKey.currentState!
                                            ...
                                            } else if (widget.lead.leadStatus !=
                                                LeadStatus.sold) {
                                              lead.leadStatus =
                                            ...
                                            lead.superAgentComission =
                                                superAgentComission.comission;
                                            lead.sellingAmount =
                                                sellingAmount.doubleValue;
                                            print(lead.toJson());
