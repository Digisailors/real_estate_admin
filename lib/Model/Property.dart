...
enum Facing { North, West, East, South, North_East, North_West, South_East, South_West }
...
class Property {
  ...
  factory Property.fromSnapshot(DocumentSnapshot snapshot) {
    ...
    return Property(
      ...
      propertyAmounts: json["propertyAmounts"] is int ? (json["propertyAmounts"] as int).toDouble() : (json["propertyAmounts"] ?? 0),
      sellingAmount: json["sellingAmount"] is int ? (json["sellingAmount"] as int).toDouble() : (json["sellingAmount"] ?? 0),
      sellingAmounts: json["sellingAmounts"] is int ? (json["sellingAmounts"] as int).toDouble() : (json["sellingAmounts"] ?? 0),
